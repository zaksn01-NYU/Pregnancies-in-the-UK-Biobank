...
# ===================================================================================================
# CREATE TWO SEPERATE DATAFRAMES OF ALL PREGNANCY CODES USING: (1) HOSPITAL AND (2) PRIMARY CARE DATA 
# ===================================================================================================
...
# load data
hesin_diagnosis = fread("Data/raw_UKB/hesin_diag.csv", na.strings=c("", NA))
hesin = fread("Data/raw_UKB/hesin.csv", na.strings=c("", NA))
ICD9to10conversion = read_excel("Data/raw_UKB/primarycare_codings/all_lkps_maps_v4.xlsx", na=c("", NA), sheet="icd9_icd10")
...
# export
write.csv(hesin_preg_complete, "Data/processed/Step1A_ExtractPregnancyCodes_Hospital.csv", row.names = F)
...
# load data
v2codes = read_excel("Data/raw_UKB/primarycare_codings/all_lkps_maps_v4.xlsx", na=c("", NA), sheet="read_v2_icd10")
CTV3codes = read_excel("Data/raw_UKB/primarycare_codings/all_lkps_maps_v4.xlsx", na=c("", NA), sheet="read_ctv3_icd10")
PrimaryCare = fread("Data/raw_UKB/gp_clinical.csv",na.strings=c("", NA))
...
# export
write.csv(PrimaryCare_preg_complete,"Data/processed/Step1B_ExtractPregnancyCodes_PrimaryCare.csv",row.names = F )
