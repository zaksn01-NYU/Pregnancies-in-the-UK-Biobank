...
-***PRS_PrinicalComponents.txt*** – A user-generated file that contains the first ten user-calculated genetic principal components, with columns titled ‘eid’, ‘PC1’ - ‘PC10’
