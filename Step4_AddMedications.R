...
# ======================================
# CLASSIFY PSYCHOTROPIC MEDICATION USERS
# ======================================
...
# load data
drugs = fread("Data/raw_UKB/gp_scripts.csv",na.strings=c("", NA))
BNF_map = read_excel("Data/raw_UKB/primarycare_codings/all_lkps_maps_v4.xlsx", na=c("", NA), sheet="bnf_lkp")
READ_map = read_excel("Data/raw_UKB/primarycare_codings/all_lkps_maps_v4.xlsx", na=c("", NA), sheet="read_v2_drugs_lkp")
pregnancies = fread("Data/processed/Step3_AddPsychiatricDxs.csv", na.strings=c("", NA)) ##FIX NAME
...
# export
write.csv(pregnancies_1,"Data/processed/Step4_AddMedications.csv",row.names=F)
