...
# ========================================
# IDENTIFY PSYCHIATRIC CASES AND CONTROLS
# ========================================
...
pregnancies = fread("Data/processed/Step2_ClusterPregnancies.csv", na.strings=c("", NA))
...
# export
write.csv(pregnancies_1,"Data/processed/Step3_AddPsychiatricDxs.csv",row.names=F)
